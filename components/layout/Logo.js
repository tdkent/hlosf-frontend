...
const Logo = () => {
  return (
    ...
    <div className="flex flex-col items-center justify-center h-[100px] xl:h-[130px] 2xl:h-[160px] bg-hero-pattern bg-no-repeat bg-cover bg-center">
      <h1 className="header-text z-10 font-serif text-center text-lg min-[360px]:text-xl min-[375px]:text-2xl md:text-3xl xl:text-4xl 2xl:text-5xl text-white select-none">
